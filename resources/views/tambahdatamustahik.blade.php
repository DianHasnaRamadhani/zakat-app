...
<html lang="en">
  ...
  <body>
    <h1>Tambah Data Mustahik</h1>

    <div class="container">
        <div class="row">
            <div class="card">
              <div class="card-body">
                <form action="/insertdatamustahik" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div class="mb-3">
                  ...
                  <div class="mb-3">
                    ...
                    <input type="text" name = "mustahik_kategori_id" class="form-control" id="fullname" aria-describedby="name">
                  </div>
                  <div class="mb-3">
